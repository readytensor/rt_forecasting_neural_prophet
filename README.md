# Neural Prophet Forecaster

Neural Prophet Forecaster for the Forecasting problem category as per Ready Tensor specifications.
...
- A **Neural Prophet Forecaster** algorithm built using **Neural Prophet**
...
- **`src/`**: This directory holds the source code for the project. It is further divided into various subdirectories:
  ...
  - **`prediction/`**: Scripts for the forecaster model implemented using **Neural Prophet** library.
